      ...
      content: () => (
        <div className="bg-white rounded-xl p-4 shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-4">
            {Object.entries(response?.weather || {}).length > 0 ? (
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-600">
              {response?.suitability || "No suitability information provided."}
            </p>
            <div className="mt-2 flex flex-wrap gap-2">
              {Array.isArray(response?.risks) && response.risks.length > 0 ? (
                ...
                <p className="text-sm text-gray-500">No risks reported.</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              {Object.entries(response?.soilAnalysis || {}).length > 0 ? (
            ...
            <div>
              ...
              {Array.isArray(response?.fertilizerRecommendations) &&
              response.fertilizerRecommendations.length > 0 ? (
                response.fertilizerRecommendations.map((fert, index) => (
                  <div
                    key={index}
                    className="bg-green-50 p-2 rounded-lg mb-2"
                  >
      ...
      content: () => (
        <div className="bg-white rounded-xl p-4 shadow-lg">
          ...
          <div className="space-y-4">
            {Object.entries(response?.farmingGuide || {}).length > 0 ? (
            ...
            <div className="mt-4 bg-yellow-50 p-3 rounded-lg">
              ...
              <div>
                {Array.isArray(response?.specialConsiderations) &&
                response.specialConsiderations.length > 0 ? (
                  ...
                  <p className="text-gray-600">None mentioned.</p>
                )}
              </div>
            </div>
          </div>
